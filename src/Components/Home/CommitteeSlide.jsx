    ...
    const conferenceOrganizers = [
     ...
     return (
        <div className=" mx-auto px-8 py-12">
            <h2 className="text-4xl font-bold text-center mb-12 text-[#923330]">
            ...
            <Swiper
                ...
                className="mySwiper"
            >
                {conferenceOrganizers.map((member, index) => (
