    ...
    <div className="py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <motion.h2
          ...
          viewport={{ once: true }}
          className="text-4xl md:text-5xl font-bold text-center mb-16 text-[#923330]"
        >
          Conference Tracks
        </motion.h2>
         ...
         <motion.h2
          ...
          transition={{ duration: 0.5 }}
          viewport={{ once: true }}
          className="text-md md:text-lg mx-16 text-center mb-16 text-[#923330]"
        >
        ...
        <motion.div
          ...
          className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-10 mx-16"
        >
